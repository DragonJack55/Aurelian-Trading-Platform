                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16 fade-up visible">
                        ...
                        <div className="relative z-10 h-[380px] sm:h-[600px] lg:h-[750px] flex items-center justify-center translate-x-4 sm:translate-x-0 lg:translate-x-6 -mt-48 sm:-mt-64 lg:mt-0 lg:opacity-100">
                            ...
                            <img
                                ...
                                className="relative z-20 w-[140%] max-w-[140%] lg:w-[150%] lg:max-w-[150%] h-auto object-contain transform -translate-x-6 sm:-translate-x-12 translate-y-8 lg:translate-x-12 lg:-translate-y-8 mix-blend-lighten drop-shadow-2xl opacity-100 transition-transform duration-[2000ms] ease-out"
                            />
                        </div>
                    </div>
