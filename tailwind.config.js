        ...
        extend: {
            ...
            keyframes: {
                ...
                orbitBitcoin: {
                    ...
                    '30%':  { transform: 'translate(0px, -140px) scale(0.8)', zIndex: '10', opacity: '0.7' },
                    '45%':  { transform: 'translate(160px, -100px) scale(0.75)', zIndex: '10', opacity: '0.6' },
                    '55%':  { transform: 'translate(200px, 0px) scale(0.75)', zIndex: '10', opacity: '0.65' },
                    '70%':  { transform: 'translate(140px, 100px) scale(0.85)', zIndex: '30', opacity: '0.85' },
                ...
                orbitEuro: {
                    ...
                    '15%':  { transform: 'translate(100px, -160px) scale(0.9)', zIndex: '30', opacity: '0.95' },
                    '30%':  { transform: 'translate(-60px, -130px) scale(0.75)', zIndex: '10', opacity: '0.65' },
                    '45%':  { transform: 'translate(-180px, -40px) scale(0.75)', zIndex: '10', opacity: '0.6' },
                    '55%':  { transform: 'translate(-170px, 60px) scale(0.75)', zIndex: '10', opacity: '0.65' },
                    '70%':  { transform: 'translate(-60px, 120px) scale(0.85)', zIndex: '30', opacity: '0.85' },
                ...
                orbitYen: {
                    '0%':   { transform: 'translate(160px, 60px) scale(1)', zIndex: '30', opacity: '1' },
                    '15%':  { transform: 'translate(200px, -60px) scale(0.95)', zIndex: '30', opacity: '1' },
                    '30%':  { transform: 'translate(100px, -150px) scale(0.8)', zIndex: '10', opacity: '0.65' },
                    '45%':  { transform: 'translate(-80px, -130px) scale(0.75)', zIndex: '10', opacity: '0.6' },
                    '55%':  { transform: 'translate(-200px, -30px) scale(0.75)', zIndex: '10', opacity: '0.65' },
                    '70%':  { transform: 'translate(-150px, 90px) scale(0.85)', zIndex: '30', opacity: '0.85' },
                    '85%':  { transform: 'translate(-20px, 130px) scale(0.95)', zIndex: '30', opacity: '1' },
                    '100%': { transform: 'translate(160px, 60px) scale(1)', zIndex: '30', opacity: '1' },
                },
                orbitGoldbar: {
                    '0%':   { transform: 'translate(140px, 120px) rotate(12deg) scale(1)', zIndex: '30', opacity: '1' },
                    '15%':  { transform: 'translate(220px, 20px) rotate(8deg) scale(0.95)', zIndex: '30', opacity: '1' },
                    '30%':  { transform: 'translate(140px, -110px) rotate(5deg) scale(0.8)', zIndex: '10', opacity: '0.65' },
                    '45%':  { transform: 'translate(-40px, -140px) rotate(0deg) scale(0.75)', zIndex: '10', opacity: '0.6' },
                    '55%':  { transform: 'translate(-180px, -60px) rotate(-3deg) scale(0.75)', zIndex: '10', opacity: '0.65' },
                    '70%':  { transform: 'translate(-160px, 70px) rotate(0deg) scale(0.85)', zIndex: '30', opacity: '0.85' },
                    '85%':  { transform: 'translate(-40px, 140px) rotate(8deg) scale(0.95)', zIndex: '30', opacity: '1' },
